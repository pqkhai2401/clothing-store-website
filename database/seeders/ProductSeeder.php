    ...
    private function getProductData(): array
    {
        return [
            ...
            [
                ...
                'price'       => 350000,
                'thumbnail'   => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ_8b9BySn67YtyVRusqWAkzxOaG90Ye_DyZNOvYO3kSQ&s=10',
                'category'    => 'tui-xach',
                'brand'       => 'Converse',
                'gender'      => 'unisex',
                'is_featured' => false,
                'views_count' => 231,
                'images'      => [
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDbbul94AfHJ4Ntr92TUGgdl03-rqWv7pb7VCfuTf-qQ&s',
                ],
                'colors' => ['Đen', 'Trắng'],
                'sizes'  => ['M'],
                'tags'   => ['casual', 'dao-pho'],
            ...
            [
                'name'        => 'Túi Xách Da Nữ Sang Trọng',
                'slug'        => 'tui-xach-da-nu-sang-trong-zara',
                'description' => 'Túi xách nữ Zara chất da thật cao cấp, form vuông tối giản sang trọng. Khóa kim loại mạ vàng tinh xảo, quai đeo vai kèm quai xách tay. Lót trong lụa mềm mại. Item hoàn thiện phong cách công sở, dạo phố đẳng cấp.',
                'price'       => 1290000,
                'thumbnail'   => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ5Y2bLcc6153EfNLb7MzusoUjJqdbRpcIiSnIJ1a4xIQ&s=10',
                'category'    => 'tui-xach',
                'brand'       => 'Zara',
                'gender'      => 'women',
                'is_featured' => true,
                'views_count' => 142,
                'images'      => [
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRLJcQ9xDG7qm7YCdBgUPRJSMHu7qdRZybmj25kh5cGEg&s=10',
                ],
                'colors' => ['Be','Đen'],
                'sizes'  => ['M'],
                'tags'   => ['cao-cap', 'cong-so'],
            ],
            [
                'name'        => 'Kính Râm Nữ Gọng Vuông Sang Trọng',
                'slug'        => 'kinh-ram-nu-gong-vuong-zara',
                'description' => 'Kính râm nữ Zara gọng vuông bản to, tròng kính chống UV400 chuẩn. Chất liệu acetate cao cấp bền nhẹ, form tôn khuôn mặt sang trọng. Phụ kiện hoàn thiện set đồ dạo phố, du lịch hoặc công sở mùa nắng.',
                'price'       => 590000,
                'thumbnail'   => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoidqL-prAhmGvPsWnXQQ9haoEGIEte-vtrOonplJncA&s',
                'category'    => 'kinh-ram',
                'brand'       => 'Zara',
                'gender'      => 'women',
                'is_featured' => true,
                'views_count' => 158,
                'images'      => [
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQoidqL-prAhmGvPsWnXQQ9haoEGIEte-vtrOonplJncA&s',
                ],
                'colors' => ['Đen'],
                'sizes'  => ['M'],
                'tags'   => ['cao-cap', 'xu-huong'],
            ],
            [
                'name'        => 'Kính Râm Phi Công Unisex Cổ Điển',
                'slug'        => 'kinh-ram-phi-cong-unisex-hm',
                'description' => 'Kính râm phi công H&M dáng cổ điển aviator, gọng kim loại mảnh nhẹ. Tròng kính gradient chống chói, chống tia UV. Phong cách unisex linh hoạt, phối được cả outfit casual lẫn dạo phố.',
                'price'       => 450000,
                'thumbnail'   => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4_YAW3AQBh6fvxJowfDJi-D7W6cbaaN0DLK6Ywk9zvQ&s',
                'category'    => 'kinh-ram',
                'brand'       => 'H&M',
                'gender'      => 'unisex',
                'is_featured' => false,
                'views_count' => 121,
                'images'      => [
                    'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT4_YAW3AQBh6fvxJowfDJi-D7W6cbaaN0DLK6Ywk9zvQ&s',
                ],
                'colors' => ['Đen'],
                'sizes'  => ['M'],
                'tags'   => ['xu-huong', 'casual'],
