    ...
    public function run(): void
    {
        $collectionsData = [
            [
                ...
                'banner' => 'images/collections/spring_collection.png',
                'status' => true,
            ],
            [
                'name' => 'Bộ sưu tập Hạ',
                ...
                'banner' => 'images/collections/summer_collection.png',
                'status' => true,
            ],
            [
                'name' => 'Bộ sưu tập Thu',
                ...
                'banner' => 'images/collections/autumn_collection.png',
                'status' => true,
            ],
            [
                ...
                'banner' => 'images/collections/winter_collection.png',
                'status' => true,
            ],
        ];
