    ...
    public function run(): void
    {
        $collectionsData = [
            [
                ...
                'banner' => 'images/collection/collection_spring.png',
                'status' => true,
            ],
            [
                'name' => 'Bộ sưu tập Hạ',
                ...
                'banner' => 'images/collection/collection_summer.png',
                'status' => true,
            ],
            [
                'name' => 'Bộ sưu tập Thu',
                ...
                'banner' => 'images/collection/collection_autumn.png',
                'status' => true,
            ],
            [
                ...
                'banner' => 'images/collection/collection_winter.png',
                'status' => true,
            ],
        ];
