...
<style>
    ...
    .supplier-status-dropdown { position: relative; display: inline-block; width: auto; }
    ...
    .supplier-status-trigger:hover { filter: brightness(0.97); }
    .supplier-status-trigger:focus { outline: none; box-shadow: 0 0 0 3px rgba(22, 163, 74, 0.15); }
    .supplier-status-caret { font-size: 9px; opacity: .65; transition: transform .15s; }
    .supplier-status-trigger.is-open .supplier-status-caret { transform: rotate(180deg); }
    .supplier-status-dropdown .hk-cat-panel { left: 0; right: auto; width: 170px; }
    ...
    .product-admin-page .supplier-table-wrap,
    .product-admin-page .supplier-pagination-bar {
        box-shadow: 0 4px 6px -1px rgb(0 0 0 / 0.05), 0 2px 4px -2px rgb(0 0 0 / 0.05);
    }
    .product-admin-page .supplier-table-wrap { border-radius: 12px 12px 0 0 !important; }
    .product-admin-page .supplier-pagination-bar {
        border-radius: 0 0 12px 12px !important;
        border-color: #E2E8F0 !important;
    }
    [data-theme="dark"] .product-admin-page .supplier-pagination-bar {
