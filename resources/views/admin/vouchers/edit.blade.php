...
@section('title', 'Sửa voucher: ' . $voucher->code)
...
<main class="app-main container-fluid py-4">
    ...
    <div class="d-flex align-items-center justify-content-between gap-3 mb-4 flex-wrap">
        <div>
            <h1 class="create-header-title mb-1">Sửa voucher</h1>
            <p class="create-header-desc mb-0">ID: {{ $voucher->id }} — <strong>{{ $voucher->code }}</strong></p>
        </div>
    ...
    <form method="POST" action="{{ route('admin.vouchers.update', $voucher->id) }}" id="voucherEditForm">
        @csrf
        @method('PUT')
                    ...
                    <div class="card-body">
                        <div class="voucher-field">
                            ...
                            <input type="text" id="code" name="code"
                                ...
                                value="{{ old('code', $voucher->code) }}" placeholder="VD: SALE50" maxlength="50" required autofocus>
                            @error('code') <div class="invalid-feedback">{{ $message }}</div> @enderror
                        </div>

                        <div class="voucher-field">
                            <label>Kiểu giảm giá <span class="text-danger">*</span></label>
                            @php $oldType = old('type', $voucher->type); @endphp
                        ...
                        <div class="voucher-field-row">
                            <div class="voucher-field">
                                ...
                                <input type="number" id="value" name="value" min="0" step="0.01"
                                    ...
                                    value="{{ old('value', (float) $voucher->value) }}" required>
                            ...
                            <div class="voucher-field">
                                ...
                                <input type="number" id="quantity" name="quantity" min="{{ $voucher->used_count }}" step="1"
                                    class="form-control @error('quantity') is-invalid @enderror"
                                    value="{{ old('quantity', $voucher->quantity) }}" required>
                                <div class="form-text">Đã dùng {{ $voucher->used_count }} lượt — không thể đặt thấp hơn số này.</div>
                        ...
                        <div class="voucher-field-row">
                            <div class="voucher-field">
                                ...
                                <input type="number" id="min_order_amount" name="min_order_amount" min="0" step="1000"
                                    ...
                                    value="{{ old('min_order_amount', (float) $voucher->min_order_amount) }}">
                            ...
                            <div class="voucher-field">
                                ...
                                <input type="number" id="max_discount_amount" name="max_discount_amount" min="0" step="1000"
                                    ...
                                    value="{{ old('max_discount_amount', $voucher->max_discount_amount !== null ? (float) $voucher->max_discount_amount : '') }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="voucher-field">
                            ...
                            <div class="voucher-status-toggle">
                                ...
                                <label for="status">Cho phép sử dụng</label>
                            </div>
                        </div>
        ...
        <div class="voucher-form-actions">
            <a href="{{ route('admin.vouchers.list') }}" class="btn btn-light" data-voucher-edit-close>
