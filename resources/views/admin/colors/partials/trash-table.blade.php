                                ...
                                <div class="dropdown-menu dropdown-menu-end product-row-menu">
                                    <form method="POST" action="{{ route('admin.colors.restore', $color->id) }}">
                                        ...
                                        <button type="button" class="dropdown-item"
                                            onclick="window.showConfirm({title: 'Xác nhận khôi phục', message: 'Bạn có chắc chắn muốn khôi phục màu sắc này không?', type: 'warning'}).then(ok => { if(ok) this.closest('form').submit(); })">
