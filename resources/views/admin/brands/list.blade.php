...
@section('content')
    <main class="app-main container-fluid py-4">
        ...
        <div class="d-flex align-items-start justify-content-between gap-3 mb-4 flex-wrap">
            <h1 class="h4 fw-bold mb-0" style="color:#174761;">Quản lý thương hiệu</h1>
            <div class="small text-muted">Trang chủ <span class="mx-1">/</span> Thương hiệu</div>
        </div>
        ...
        <div class="card border shadow-sm">
            <div class="card-header bg-white border-bottom">
                <form method="GET" action="{{ route('admin.brands.list') }}">
                    <div class="row g-2 align-items-center">
                        <div class="col-md-5 col-lg-4">
                            <div class="input-group">
                                <span class="input-group-text bg-white"><i class="fa-solid fa-magnifying-glass"></i></span>
                                <input type="text" name="keyword" class="form-control"
                                    value="{{ $keyword }}" placeholder="Tìm theo tên thương hiệu...">
                            </div>
                        </div>
                        <div class="col-auto">
                            ...
                            @if($keyword)
                                <a href="{{ route('admin.brands.list') }}" class="btn btn-outline-secondary fw-semibold ms-1">
                    ...
                    <table class="table table-hover table-bordered mgmt-table align-middle mb-0">
                        ...
                        <tbody>
                            @forelse($brands as $brand)
                                <tr>
                                    <td class="hk-cb-td"><input type="checkbox" class="hk-cb-row" value="{{ $brand->id }}"></td>
            ...
            <div class="card-footer bg-white">
                @include('layouts.components.pagination', ['paginator' => $brands, 'itemLabel' => 'thương hiệu', 'bulkDeleteUrl' => route('admin.brands.bulkDelete')])
            </div>
        </div>
    </main>
@endsection
