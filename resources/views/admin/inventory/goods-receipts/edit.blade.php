...
<main class="app-main container-fluid py-4">
    ...
    <div class="d-flex align-items-center justify-content-between gap-3 mb-4 flex-wrap">
        <div>
            <h1 class="gr-header-title">Chỉnh sửa phiếu nhập kho {{ $goodsReceipt->code }}</h1>
            <p class="gr-header-desc">Điều chỉnh nhà cung cấp và danh sách mặt hàng của phiếu nháp.</p>
        </div>
    </div>
