                                ...
                                <div class="dropdown-menu dropdown-menu-end product-row-menu">
                                    <form method="POST" action="{{ route('admin.sizes.restore', $size->id) }}">
                                        ...
                                        <button type="button" class="dropdown-item"
                                            onclick="window.showConfirm({title: 'Xác nhận khôi phục', message: 'Bạn có chắc chắn muốn khôi phục kích thước này không?', type: 'warning'}).then(ok => { if(ok) this.closest('form').submit(); })">
