    ...
    <main class="app-main container-fluid py-4">
        ...
        <div class="d-flex align-items-start justify-content-between gap-3 mb-4 flex-wrap">
            <h1 class="h4 fw-bold mb-0" style="color:#174761;">
                <i class="fa-solid fa-trash me-2 text-danger" style="font-size:18px;"></i>Thùng rác — Kích thước
            </h1>
            <div class="small text-muted">Trang chủ <span class="mx-1">/</span> <a href="{{ route('admin.sizes.list') }}" class="text-muted">Kích thước</a> <span class="mx-1">/</span> Thùng rác</div>
        </div>

        <div class="mb-3">
            <a href="{{ route('admin.sizes.list') }}" class="btn btn-outline-secondary page-action-btn">
        ...
        <div class="card border shadow-sm">
            <div class="card-header bg-white border-bottom">
                <form method="GET" action="{{ route('admin.sizes.trash') }}">
                    <div class="row g-2 align-items-center">
                        ...
                        <div class="col-auto">
                            ...
                            @if($keyword)
                                <a href="{{ route('admin.sizes.trash') }}" class="btn btn-outline-secondary fw-semibold ms-1"><i class="fa-solid fa-xmark me-1"></i> Xóa lọc</a>
                            @endif
                        </div>
                    </div>
                </form>
                        ...
                        <tbody>
                            @forelse($sizes as $size)
                                <tr>
                                    ...
                                    <td class="fw-semibold text-muted">{{ $size->name }}</td>
                                    <td><span class="deleted-at">{{ $size->deleted_at?->format('d/m/Y H:i') }}</span></td>
            ...
            <div class="card-footer bg-white">
                @include('layouts.components.pagination', ['paginator' => $sizes, 'itemLabel' => 'kích thước'])
            </div>
        </div>
    </main>
@endsection
