                    ...
                    <div class="d-flex align-items-start justify-content-between gap-3">
                        <div>
                            ...
                            <p class="form-subtitle mb-0">
                                Điền đầy đủ thông tin để cập nhật hồ sơ người dùng trong hệ thống.
                            </p>
                        </div>
                    </div>
                </div>
                <form method="POST" action="{{ route('admin.users.update', $user->id) }}" autocomplete="off" autocorrect="off"
                        ...
                        <div class="row g-3 form-grid">
                            ...
                            <div class="col-12">
                                ...
                                <input type="text" name="user_name" id="user_name"
                                    ...
                                    value="{{ old('user_name', $user->user_name) }}" placeholder="Nhập tên đăng nhập" />
                                @error('user_name')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                <label for="password_confirmation" class="form-label">
                                    Xác nhận mật khẩu mới: <small class="text-muted">(Để trống nếu không đổi)</small>
                                </label>
                                <div class="input-group">
